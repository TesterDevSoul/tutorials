...
//
////关键字对应的page页面
//public class AppBasePage1 {
//    // 创建固定大小的线程池，最多同时执行3个线程
...
//    public AppBasePage1(AndroidDriver androidDriver) {
...
////        commandRunner.runCommand(command + port);
////
////        // 打印结果
...
//////                commandRunner.runCommand(killCommand + pid);
//////                logger.info("端口 {} 的进程已被终止", port);
//////
////////                // 关闭线程池
////////                commandRunner1.shutdown();
//////            }
//////        });
////        // 关闭线程池
...
//                            try {
//                                executor1.execute(commandLine, handler);
//                                // 等待命令执行完成
//                                handler.waitFor();
//                                // 处理执行结果
